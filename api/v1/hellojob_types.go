...
// HelloJob is the Schema for the hellojobs API
type HelloJob struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   HelloJobSpec   `json:"spec,omitempty"`
	Status HelloJobStatus `json:"status,omitempty"`
}
...
type HelloJobList struct {
	...
	Items           []HelloJob `json:"items"`
}

func init() {
	SchemeBuilder.Register(&HelloJob{}, &HelloJobList{})
}
